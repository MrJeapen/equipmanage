...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field: 'note', title: '备注'}
      ,{field: 'detailId', hide:true, title: '详情'}

      ,{title: '详情', align: 'center', fixed: 'right', toolbar: '#table-system-order'}
    ]]
    ,page: true
    ,limit: 10
    ...
    if(obj.event === 'edit'){
      admin.popup({
        ...
        ,success: function(layero, index){
          view(this.id).render('./check/form').done(function(){

            table.render({
              elem: '#demo'
              ,height: 312
              ,url: '/detail?detailId=' + data.detailId //数据接口
              ,page: true //开启分页
              ,cols: [[ //表头
                {field: 'item', title: '点检项目'}
                ,{field: 'detail', title: '点检详情'}
